...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->data_i = VL_RAND_RESET_I(3);
    vlSelf->result_o = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__dut__DOT__unusedgate = VL_RAND_RESET_I(4);
    vlSelf->top__DOT__dut__DOT__data_out = VL_RAND_RESET_I(8);
